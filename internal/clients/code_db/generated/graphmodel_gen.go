...
type CreateRepositoriesMutationResponse {
  repositories: [Repository!]!
}

type UpdateRepositoriesMutationResponse {
  repositories: [Repository!]!
}
...
type MergeRepositoriesMutationResponse {
  repositories: [Repository!]!
}
...
type MergeClassesMutationResponse {
  classes: [Class!]!
}
...
type Query {
  ...
  repositories(where: RepositoryWhere, sort: [RepositorySort!]): [Repository!]!
  repositoriesConnection(first: Int, after: String, where: RepositoryWhere, sort: [RepositorySort!]): RepositoriesConnection!
  ...
  classes(where: ClassWhere, sort: [ClassSort!]): [Class!]!
  classesConnection(first: Int, after: String, where: ClassWhere, sort: [ClassSort!]): ClassesConnection!
...
type Mutation {
  ...
  createRepositories(input: [RepositoryCreateInput!]!): CreateRepositoriesMutationResponse!
  updateRepositories(where: RepositoryWhere, update: RepositoryUpdateInput): UpdateRepositoriesMutationResponse!
  deleteRepositories(where: RepositoryWhere): DeleteInfo!
  mergeRepositories(input: [RepositoryMergeInput!]!): MergeRepositoriesMutationResponse!
  ...
  createClasses(input: [ClassCreateInput!]!): CreateClassesMutationResponse!
  updateClasses(where: ClassWhere, update: ClassUpdateInput): UpdateClassesMutationResponse!
  deleteClasses(where: ClassWhere): DeleteInfo!
  mergeClasses(input: [ClassMergeInput!]!): MergeClassesMutationResponse!
