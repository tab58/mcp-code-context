...
// HandleFindDeadCode handles the find_dead_code tool call.
...
func (svc *Manager) HandleFindDeadCode(ctx context.Context, repo string, excludeDecorated bool, excludePatterns string, limit int) (*DeadCodeResponse, error) {
	if repo == "" {
