...
func TestHandleFindFunction_FoundResult(t *testing.T) {
	...
	resp, err := s.handleFindFunction(context.Background(), "myrepo", "getUserByID")
	if err != nil {
...
func TestHandleFindFunction_NotFound(t *testing.T) {
	...
	resp, err := s.handleFindFunction(context.Background(), "myrepo", "nonexistent")
	if err != nil {
		t.Fatalf("handleFindFunction returned error: %v", err)
	}
	if resp == nil {
...
func TestHandleFindFile_GlobMatch(t *testing.T) {
	...
	resp, err := s.handleFindFile(context.Background(), "myrepo", "*.go")
	if err != nil {
...
func TestHandleFindFile_SymbolEnrichment(t *testing.T) {
	...
	resp, err := s.handleFindFile(context.Background(), "myrepo", "cmd/main.go")
	if err != nil {
		t.Fatalf("handleFindFile returned error: %v", err)
	}
	if resp == nil {
...
func TestHandleFindFile_NoMatch(t *testing.T) {
	...
	resp, err := s.handleFindFile(context.Background(), "myrepo", "*.py")
	if err != nil {
		t.Fatalf("handleFindFile returned error: %v", err)
	}
	if resp == nil {
...
func TestHandleSearchCode_FileStrategy(t *testing.T) {
	...
	resp, err := s.handleSearchCode(context.Background(), "myrepo", "*.go", 10)
	if err != nil {
...
func TestHandleSearchCode_ExactStrategy(t *testing.T) {
	...
	resp, err := s.handleSearchCode(context.Background(), "myrepo", "getUserByID", 10)
	if err != nil {
		t.Fatalf("handleSearchCode returned error: %v", err)
	}
	if resp == nil {
...
func TestValidation_FindFunction_MissingRepository(t *testing.T) {
	s := newTestServer(t)
	_, err := s.handleFindFunction(context.Background(), "", "myFunc")
	if err == nil {
...
func TestValidation_FindFunction_MissingName(t *testing.T) {
	s := newTestServer(t)
	_, err := s.handleFindFunction(context.Background(), "myrepo", "")
	if err == nil {
...
func TestValidation_FindFile_MissingRepository(t *testing.T) {
	s := newTestServer(t)
	_, err := s.handleFindFile(context.Background(), "", "*.go")
	if err == nil {
		t.Fatal("expected error for missing repository, got nil")
	}
	if !strings.Contains(err.Error(), "repository") {
...
func TestValidation_FindFile_MissingPattern(t *testing.T) {
	s := newTestServer(t)
	_, err := s.handleFindFile(context.Background(), "myrepo", "")
	if err == nil {
...
func TestValidation_SearchCode_MissingRepository(t *testing.T) {
	s := newTestServer(t)
	_, err := s.handleSearchCode(context.Background(), "", "query", 10)
	if err == nil {
		t.Fatal("expected error for missing repository, got nil")
	}
	if !strings.Contains(err.Error(), "repository") {
...
func TestValidation_SearchCode_MissingQuery(t *testing.T) {
	s := newTestServer(t)
	_, err := s.handleSearchCode(context.Background(), "myrepo", "", 10)
	if err == nil {
