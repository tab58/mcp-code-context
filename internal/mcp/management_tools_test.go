...
func TestHandleIngestRepository_MissingPath(t *testing.T) {
	s := newTestServer(t)
	_, err := s.handleIngestRepository(context.Background(), "")
	if err == nil {
...
func TestHandleIngestRepository_PathDoesNotExist(t *testing.T) {
	s := newTestServer(t)
	_, err := s.handleIngestRepository(context.Background(), "/nonexistent/path/xyz")
	if err == nil {
...
func TestHandleIngestRepository_PathIsFile(t *testing.T) {
	...
	s := newTestServer(t)
	_, err := s.handleIngestRepository(context.Background(), tmpFile)
	if err == nil {
...
func TestHandleIngestRepository_NoIndexer(t *testing.T) {
	s := newTestServer(t)
	s.idx = nil
	_, err := s.handleIngestRepository(context.Background(), t.TempDir())
	if err == nil {
...
func TestHandleIngestRepository_Success(t *testing.T) {
	...
	s := newTestServerWithIndexer(t)
	resp, err := s.handleIngestRepository(context.Background(), dir)
	if err != nil {
...
func TestHandleDeleteRepository_MissingRepo(t *testing.T) {
	s := newTestServer(t)
	_, err := s.handleDeleteRepository(context.Background(), "")
	if err == nil {
...
func TestHandleDeleteRepository_Success(t *testing.T) {
	s, drv := newTestServerWithResponses(t, nil)
	_ = drv
	resp, err := s.handleDeleteRepository(context.Background(), "myrepo")
	if err != nil {
		t.Fatalf("unexpected error: %v", err)
	}
...
func TestHandleDeleteRepository_WriteCalls(t *testing.T) {
	s, drv := newTestServerWithResponses(t, nil)
	_, err := s.handleDeleteRepository(context.Background(), "myrepo")
	if err != nil {
		t.Fatalf("unexpected error: %v", err)
	}
...
func TestHandleGetRepositoryStats_MissingRepo(t *testing.T) {
	s := newTestServer(t)
	_, err := s.handleGetRepositoryStats(context.Background(), "")
	if err == nil {
		t.Fatal("expected error for empty repository")
	}
}
...
func TestHandleGetRepositoryStats_EmptyRepo(t *testing.T) {
	s := newTestServer(t)
	resp, err := s.handleGetRepositoryStats(context.Background(), "empty-repo")
	if err != nil {
		t.Fatalf("unexpected error: %v", err)
	}
...
func TestHandleGetRepositoryStats_WithData(t *testing.T) {
	...
	s, _ := newTestServerWithResponses(t, responses)
	resp, err := s.handleGetRepositoryStats(context.Background(), "myrepo")
	if err != nil {
		t.Fatalf("unexpected error: %v", err)
	}
