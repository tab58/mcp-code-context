...
func TestHandleFindCallChain_EmptyRepo(t *testing.T) {
	...
	_, err := s.handleFindCallChain(context.Background(), "", "funcA", "funcB", 3)
	if err == nil {
...
func TestHandleFindCallChain_EmptySource(t *testing.T) {
	...
	_, err := s.handleFindCallChain(context.Background(), "myrepo", "", "funcB", 3)
	if err == nil {
...
func TestHandleFindCallChain_EmptyTarget(t *testing.T) {
	...
	_, err := s.handleFindCallChain(context.Background(), "myrepo", "funcA", "", 3)
	if err == nil {
...
func TestHandleFindCallChain_DirectCall(t *testing.T) {
	...
	s, _ := newTestServerWithResponses(t, []driver.Result{calleesOfA, callersOfB})

	resp, err := s.handleFindCallChain(context.Background(), "myrepo", "funcA", "funcB", 5)
	if err != nil {
...
func TestHandleFindCallChain_NoPath(t *testing.T) {
	...
	s, _ := newTestServerWithResponses(t, []driver.Result{empty, empty, empty, empty, empty, empty, empty, empty, empty, empty})

	resp, err := s.handleFindCallChain(context.Background(), "myrepo", "funcA", "funcZ", 3)
	if err != nil {
		t.Fatalf("handleFindCallChain error: %v", err)
	}
	if resp == nil {
...
func TestHandleFindCallChain_MaxDepthCapped(t *testing.T) {
	...
	s, drv := newTestServerWithResponses(t, results)

	resp, err := s.handleFindCallChain(context.Background(), "myrepo", "funcA", "funcZ", 10)
	if err != nil {
		t.Fatalf("handleFindCallChain error: %v", err)
	}
	if resp == nil {
...
func TestHandleFindCallChain_SameSourceTarget(t *testing.T) {
	...
	resp, err := s.handleFindCallChain(context.Background(), "myrepo", "funcA", "funcA", 5)
	if err != nil {
		t.Fatalf("handleFindCallChain error: %v", err)
	}
	if resp == nil {
