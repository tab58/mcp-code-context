...
func TestTraverseHops_SingleHop(t *testing.T) {
	...
	results, err := s.traverseHops(
		context.Background(),
		mustForRepo(t, s, "myrepo"),
		[]string{"main"},
		gqlFindCallers,
...
func TestHandleGetCallers_SingleHop(t *testing.T) {
	...
	resp, err := s.handleGetCallers(context.Background(), "myrepo", "target", 1)
	if err != nil {
...
func TestHandleGetCallees_SingleHop(t *testing.T) {
	...
	resp, err := s.handleGetCallees(context.Background(), "myrepo", "source", 1)
	if err != nil {
...
func TestHandleGetCallers_Validation(t *testing.T) {
	...
	_, err := s.handleGetCallers(context.Background(), "", "func", 1)
	if err == nil {
		t.Error("expected error for missing repository, got nil")
	}

	_, err = s.handleGetCallers(context.Background(), "repo", "", 1)
	if err == nil {
...
func TestHandleGetCallees_Validation(t *testing.T) {
	...
	_, err := s.handleGetCallees(context.Background(), "", "func", 1)
	if err == nil {
		t.Error("expected error for missing repository, got nil")
	}

	_, err = s.handleGetCallees(context.Background(), "repo", "", 1)
	if err == nil {
		t.Error("expected error for missing name, got nil")
	}
}
...
func TestHandleGetCallers_DepthClamping(t *testing.T) {
	...
	resp, err := s.handleGetCallers(context.Background(), "myrepo", "target", 0)
	if err != nil {
		t.Fatalf("handleGetCallers returned error: %v", err)
	}
	if resp.Depth != 1 {
...
func TestHandleGetClassHierarchy_Up(t *testing.T) {
	...
	resp, err := s.handleGetClassHierarchy(context.Background(), "myrepo", "MyClass", "up", 1)
	if err != nil {
...
func TestHandleGetClassHierarchy_Down(t *testing.T) {
	...
	resp, err := s.handleGetClassHierarchy(context.Background(), "myrepo", "MyInterface", "down", 1)
	if err != nil {
		t.Fatalf("handleGetClassHierarchy returned error: %v", err)
	}
	if resp == nil {
...
func TestHandleGetClassHierarchy_Both(t *testing.T) {
	...
	resp, err := s.handleGetClassHierarchy(context.Background(), "myrepo", "MyClass", "both", 1)
	if err != nil {
		t.Fatalf("handleGetClassHierarchy returned error: %v", err)
	}
	if resp == nil {
...
func TestHandleGetClassHierarchy_DefaultDirection(t *testing.T) {
	...
	resp, err := s.handleGetClassHierarchy(context.Background(), "myrepo", "MyClass", "", 1)
	if err != nil {
		t.Fatalf("handleGetClassHierarchy returned error: %v", err)
	}
...
func TestHandleGetClassHierarchy_Validation(t *testing.T) {
	...
	_, err := s.handleGetClassHierarchy(context.Background(), "", "MyClass", "both", 1)
	if err == nil {
		t.Error("expected error for missing repository, got nil")
	}

	_, err = s.handleGetClassHierarchy(context.Background(), "repo", "", "both", 1)
	if err == nil {
		t.Error("expected error for missing name, got nil")
	}
}
...
func TestHandleGetDependencies_Module(t *testing.T) {
	...
	resp, err := s.handleGetDependencies(context.Background(), "myrepo", "mymodule", 1)
	if err != nil {
...
func TestHandleGetDependencies_File(t *testing.T) {
	...
	resp, err := s.handleGetDependencies(context.Background(), "myrepo", "pkg/main.go", 1)
	if err != nil {
		t.Fatalf("handleGetDependencies returned error: %v", err)
	}
	if resp == nil {
...
func TestHandleGetDependencies_Validation(t *testing.T) {
	...
	_, err := s.handleGetDependencies(context.Background(), "", "mymodule", 1)
	if err == nil {
		t.Error("expected error for missing repository, got nil")
	}

	_, err = s.handleGetDependencies(context.Background(), "repo", "", 1)
	if err == nil {
		t.Error("expected error for missing name, got nil")
	}
}
...
func TestHandleGetReferences_Function(t *testing.T) {
	...
	resp, err := s.handleGetReferences(context.Background(), "myrepo", "myFunc")
	if err != nil {
...
func TestHandleGetReferences_Class(t *testing.T) {
	...
	resp, err := s.handleGetReferences(context.Background(), "myrepo", "MyClass")
	if err != nil {
		t.Fatalf("handleGetReferences returned error: %v", err)
	}
	if resp == nil {
...
func TestHandleGetReferences_MultiType(t *testing.T) {
	...
	resp, err := s.handleGetReferences(context.Background(), "myrepo", "MySymbol")
	if err != nil {
		t.Fatalf("handleGetReferences returned error: %v", err)
	}
	if resp == nil {
...
func TestHandleGetReferences_NoMatch(t *testing.T) {
	...
	resp, err := s.handleGetReferences(context.Background(), "myrepo", "nonexistent")
	if err != nil {
		t.Fatalf("handleGetReferences returned error: %v", err)
	}
	if resp == nil {
...
func TestHandleGetReferences_Validation(t *testing.T) {
	...
	_, err := s.handleGetReferences(context.Background(), "", "myFunc")
	if err == nil {
		t.Error("expected error for missing repository, got nil")
	}

	_, err = s.handleGetReferences(context.Background(), "repo", "")
	if err == nil {
		t.Error("expected error for missing name, got nil")
	}
}
...
// TestNewServer_RegistersEightTools verifies that NewServer creates an
// MCP server with 8 registered tools (3 search + 5 traversal).
// Expected result: server.mcp is not nil and has 8 tools.
func TestNewServer_RegistersEightTools(t *testing.T) {
	...
	// We can't directly count tools via mcp-go API, but we verify
	// the server was constructed without panicking with all 8 tools
}

// === Helper ===

// mustForRepo returns a *client.Client from ForRepo or fails the test.
func mustForRepo(t *testing.T, s *Server, repo string) *client.Client {
	t.Helper()
