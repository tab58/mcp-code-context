...
func (s *Server) handleFindCallChain(ctx context.Context, repo, source, target string, maxDepth int) (*CallChainResponse, error) {
	if repo == "" {
...
// Returns the next frontier, a meet point (if the opposite frontier was reached),
// and any error. Updates visited in place.
