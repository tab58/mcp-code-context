...
func TestFindFunction_NoSource(t *testing.T) {
	...
	resp, err := s.handleFindFunction(context.Background(), "myrepo", "GetUser")
	if err != nil {
...
// TestToContextMCPResult_MarshalJSON verifies marshalMCPResult marshals
// any struct to JSON and returns an MCP text result.
// Expected: non-nil CallToolResult.
func TestToContextMCPResult_MarshalJSON(t *testing.T) {
	resp := RepoMapResponse{Repository: "test", TotalFiles: 1}
	result, err := marshalMCPResult(resp)
	if err != nil {
		t.Fatalf("marshalMCPResult error: %v", err)
	}
	if result == nil {
...
func TestHandleGetRepoMap_GroupsByDirectory(t *testing.T) {
	...
	resp, err := s.handleGetRepoMap(context.Background(), "myrepo")
	if err != nil {
...
func TestHandleGetFileOverview_SortsByLine(t *testing.T) {
	...
	resp, err := s.handleGetFileOverview(context.Background(), "myrepo", "pkg/user.go")
	if err != nil {
...
func TestHandleGetFileOverview_EmptyFile(t *testing.T) {
	...
	resp, err := s.handleGetFileOverview(context.Background(), "myrepo", "README.md")
	if err != nil {
		t.Fatalf("handleGetFileOverview error: %v", err)
	}
	if resp.Total != 0 {
...
func TestHandleGetSymbolContext_Function(t *testing.T) {
	...
	resp, err := s.handleGetSymbolContext(context.Background(), "myrepo", "GetUser")
	if err != nil {
...
func TestHandleGetSymbolContext_Class(t *testing.T) {
	...
	resp, err := s.handleGetSymbolContext(context.Background(), "myrepo", "User")
	if err != nil {
		t.Fatalf("handleGetSymbolContext error: %v", err)
	}
	if resp == nil {
...
func TestHandleGetSymbolContext_NotFound(t *testing.T) {
	...
	_, err := s.handleGetSymbolContext(context.Background(), "myrepo", "NonExistent")
	if err == nil {
...
func TestHandleReadSource_BatchFetch(t *testing.T) {
	...
	resp, err := s.handleReadSource(context.Background(), "myrepo", []string{"GetUser", "User"})
	if err != nil {
...
func TestHandleReadSource_MissingSymbolSkipped(t *testing.T) {
	...
	resp, err := s.handleReadSource(context.Background(), "myrepo", []string{"GetUser", "NonExistent"})
	if err != nil {
		t.Fatalf("handleReadSource error: %v", err)
	}
	if resp.Total != 1 {
...
func TestHandleReadSource_EmptyNames(t *testing.T) {
	s := newTestServer(t)
	_, err := s.handleReadSource(context.Background(), "myrepo", []string{})
	if err == nil {
...
// TestNewServer_12Tools verifies that NewServer registers exactly 12 tools.
// Expected: the NewServer doc comment says "12 tools" and all are registered.
func TestNewServer_12Tools(t *testing.T) {
	db := newTestDB(t)
	...
	if s.mcp == nil {
		t.Fatal("NewServer did not create MCP server")
	}
	// The server should have the 4 new context tools registered
	// We verify this by ensuring the mcpHandle adapters exist (compile-time check)
	// and that the server was created successfully with all tools.
}

// ============================================================================
// Task 9: Input validation for all 4 handlers
// ============================================================================
...
func TestValidation_GetRepoMap_MissingRepository(t *testing.T) {
	s := newTestServer(t)
	_, err := s.handleGetRepoMap(context.Background(), "")
	if err == nil {
...
func TestValidation_GetFileOverview_MissingRepository(t *testing.T) {
	s := newTestServer(t)
	_, err := s.handleGetFileOverview(context.Background(), "", "some/path.go")
	if err == nil {
		t.Fatal("expected error for missing repository, got nil")
	}
	if !strings.Contains(err.Error(), "repository") {
...
func TestValidation_GetFileOverview_MissingPath(t *testing.T) {
	s := newTestServer(t)
	_, err := s.handleGetFileOverview(context.Background(), "myrepo", "")
	if err == nil {
...
func TestValidation_GetSymbolContext_MissingRepository(t *testing.T) {
	s := newTestServer(t)
	_, err := s.handleGetSymbolContext(context.Background(), "", "GetUser")
	if err == nil {
		t.Fatal("expected error for missing repository, got nil")
	}
	if !strings.Contains(err.Error(), "repository") {
...
func TestValidation_GetSymbolContext_MissingName(t *testing.T) {
	s := newTestServer(t)
	_, err := s.handleGetSymbolContext(context.Background(), "myrepo", "")
	if err == nil {
...
func TestValidation_ReadSource_MissingRepository(t *testing.T) {
	s := newTestServer(t)
	_, err := s.handleReadSource(context.Background(), "", []string{"fn"})
	if err == nil {
		t.Fatal("expected error for missing repository, got nil")
	}
	if !strings.Contains(err.Error(), "repository") {
...
func TestValidation_ReadSource_NilNames(t *testing.T) {
	s := newTestServer(t)
	_, err := s.handleReadSource(context.Background(), "myrepo", nil)
	if err == nil {
...
func TestSearchCode_DelegatesToFindFunction_NoSource(t *testing.T) {
	...
	resp, err := s.handleSearchCode(context.Background(), "myrepo", "GetUser", 10)
	if err != nil {
...
func TestHandleReadSource_AllMissing(t *testing.T) {
	...
	resp, err := s.handleReadSource(context.Background(), "myrepo", []string{"Alpha"})
	if err != nil {
		t.Fatalf("handleReadSource error: %v", err)
	}
	if resp.Total != 0 {
...
// handler methods are callable on *Server.
...
func TestContextToolsCompile(t *testing.T) {
	...
	var _ func(context.Context, string) (*RepoMapResponse, error) = s.handleGetRepoMap
	var _ func(context.Context, string, string) (*FileOverviewResponse, error) = s.handleGetFileOverview
	var _ func(context.Context, string, string) (*SymbolContextResponse, error) = s.handleGetSymbolContext
	var _ func(context.Context, string, []string) (*ReadSourceResponse, error) = s.handleReadSource
}
